...
var TaskItemView = /*#__PURE__*/function () {
  function TaskItemView() {
    ...
    var node = args[0],
      ...
      getPos = args[2];
    this.node = node;
    this.contentDOM = createElement$1('div', {
      "class": 'task-item-content'
    });
    this.view = view;
    this.dom = createElement$1('li', {
      "class": 'task-item'
    }, createElement$1('div', {
      "class": 'task-item-checkbox'
...
var TableView = /*#__PURE__*/function () {
  function TableView(node, view, getPos, cellMinWidth) {
    ...
    this.dom = createElement$1('div', {
      "class": tableClassName
    });
    this.dom.appendChild(createElement$1('div', {
      tabindex: '0',
      "class": 'hiddenfocus'
    }));
    this.table = this.dom.appendChild(createElement$1('table'
    // {},
    // createElement('div', { class: 'rowBar' }),
    // createElement('div', { class: 'colBar' })
    ));
    this.colgroup = this.table.appendChild(createElement$1('colgroup'));
    updateColumnsOnResize(this.node, this.colgroup, this.table, this.cellMinWidth);
    this.contentDOM = this.table.appendChild(createElement$1('tbody'));
...
function updateColumnsOnResize(node, colgroup, table, cellMinWidth, overrideCol, overrideValue) {
  ...
  for (var i = 0, col = 0; i < row.childCount; i++) {
    ...
    for (var j = 0; j < colspan; j++, col++) {
      ...
      if (!nextDOM) {
        colgroup.appendChild(createElement$1('col')).style.width = cssWidth;
      } else {
...
var addToolkit = function addToolkit(table, start) {
  ...
  var _loop = function _loop(i) {
    ...
    seen[i] = true;
    result.push(prosemirrorView.Decoration.widget(start + map.map[i] + 2, function (view) {
  ...
  var _loop2 = function _loop2(_i2) {
    ...
    seen[_i2] = true;
    result.push(prosemirrorView.Decoration.widget(start + map.map[_i2] + 2, function (view) {
      return createElement$1('div', {
        "class": 'colBtn',
        onclick: function onclick() {
          var state = view.state,
  ...
  result.push(prosemirrorView.Decoration.widget(start + 1, function (view) {
    return createElement$1('div', {
      "class": 'tools'
    }, createElement$1('div', {
      "class": 'rowBar',
...
var CodeBlockView = /*#__PURE__*/function () {
  function CodeBlockView() {
    ...
    this.view = view;
    this.getPos = getPos;
    this.contentDOM = createElement$1('code', {
    ...
    this.menu = createElement$1('div', {
      "class": 'code-block-menu-container'
    });
    this.dom = createElement$1('pre', {
...
function isMarkActive(view, markType) {
  var _view$state3 = view.state,
    ...
    tr = _view$state3.tr;
  if (!(selection instanceof prosemirrorState.TextSelection)) return false;
  var $from = selection.$from,
    $to = selection.$to;
...
var Tooltip = /*#__PURE__*/function () {
  function Tooltip() {
    ...
    this.tooltip = createElement$1('div', {
      "class": 'dc-tooltip'
    });
...
var ToolBar = /*#__PURE__*/function () {
  function ToolBar(view, spec) {
    ...
    var tte = function tte() {
      var _useState = useState('div'),
    ...
    view: function view(_view) {
      ...
      return {
        ...
        update: function update(view, prevState) {
          var _toolbar;
          var sel = view.state.selection;
          if (tooltip.visible && !sel.eq(prevState.selection) && sel.empty) tooltip.hide();
