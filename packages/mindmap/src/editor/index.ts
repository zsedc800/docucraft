...
UI.setEditConfig = function (
	config: IEditorConfig | IEditorConfigFunction
): void {
...
UI.setEditOuter = function (toolName: string | IEditToolFunction): void {
	defineKey(this.prototype, 'editOuter', {
		get(): string {
			return typeof toolName === 'string' ? toolName : toolName(this);
		}
	});
};
...
UI.setEditInner = function (editorName: string | IEditToolFunction): void {
	defineKey(this.prototype, 'editInner', {
		get(): string {
			return typeof editorName === 'string' ? editorName : editorName(this);
		}
	});
};
