...
declare global {
	namespace JSX {
		// These definitions are based on @types/react
		...
		interface IntrinsicElements {
			...
			data: React.DetailedHTMLProps<
				React.DataHTMLAttributes<HTMLElement>,
				HTMLElement
			>;
			datalist: React.DetailedHTMLProps<
				React.DatalistHTMLAttributes<HTMLDataListElement>,
				HTMLDataListElement
			>;
			...
			// You can add custom elements here
		}
	}
}
