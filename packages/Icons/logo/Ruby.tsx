...
const SvgRuby = (props: SVGProps<SVGSVGElement>) => (
	...
	>
		...
		<path
			...
			d="M87.524 58.767 38.638 87.795l63.3-4.294 4.875-63.828z"
		/>
		<linearGradient
			id="ruby_svg__b"
			x1={152.913}
		...
		<path
			...
			d="M102.041 83.457 96.6 45.905l-14.818 19.57z"
		/>
		<linearGradient
			id="ruby_svg__c"
			x1={134.287}
		...
		<path
			...
			d="m102.114 83.457-39.858-3.129-23.405 7.385z"
		/>
		<linearGradient
			id="ruby_svg__d"
			x1={85.411}
		...
		<path
			...
			d="m38.906 87.722 9.957-32.62-21.91 4.686z"
		/>
		<linearGradient
			id="ruby_svg__e"
			x1={110.233}
		...
		<path
			...
			d="m81.777 65.582-9.162-35.887-26.219 24.577z"
		/>
		<linearGradient
			id="ruby_svg__f"
			x1={132.261}
		...
		<path
			...
			d="M104.734 30.201 79.949 9.958l-6.901 22.313z"
		/>
		<linearGradient
			id="ruby_svg__g"
			x1={120.105}
		...
		<path
			...
			d="m93.142 2.741-14.576 8.056-9.197-8.164z"
		/>
		<linearGradient
			id="ruby_svg__h"
			x1={70.375}
		...
		<path
			...
			d="m21.188 70.73 6.107-11.137-4.941-13.267z"
		/>
		<path
			fill="#fff"
			d="m22.026 45.905 4.97 14.098 21.595-4.845 24.655-22.913 6.958-22.1-10.955-7.737-18.627 6.971c-5.868 5.458-17.256 16.258-17.667 16.461-.406.208-7.519 13.653-10.929 20.065"
		/>
		<linearGradient
			id="ruby_svg__i"
			x1={60.669}
		...
		<path
			...
			d="M39.477 20.581C52.196 7.97 68.592.52 74.884 6.869c6.289 6.348-.38 21.776-13.099 34.382C49.067 53.858 32.873 61.719 26.586 55.37c-6.294-6.344.173-22.183 12.891-34.789"
		/>
		<linearGradient
			id="ruby_svg__j"
			x1={111.505}
		...
		<path
			...
			d="m38.906 87.709 9.879-32.724 32.811 10.541c-11.864 11.125-25.058 20.528-42.69 22.183"
		/>
		<linearGradient
			id="ruby_svg__k"
			x1={145.839}
		...
		<path
			...
			d="m73.289 32.181 8.423 33.363c9.91-10.419 18.804-21.621 23.159-35.476z"
		/>
		<linearGradient
			id="ruby_svg__l"
			x1={152.364}
		...
		<path
			...
			d="M104.785 30.236c3.371-10.174 4.148-24.768-11.746-27.477L79.996 9.963z"
		/>
		<path
			fill="#9E1209"
			d="M21.188 70.583c.467 16.789 12.581 17.04 17.741 17.188l-11.92-27.837z"
		/>
		<radialGradient
			id="ruby_svg__m"
			cx={130.847}
		...
		<path
			...
			d="M73.337 32.232c7.615 4.68 22.96 14.08 23.271 14.253.484.272 6.617-10.342 8.008-16.34z"
		/>
		<radialGradient
			id="ruby_svg__n"
			cx={100.707}
		...
		<path
			...
			d="m48.772 54.986 13.207 25.48c7.81-4.235 13.924-9.395 19.526-14.922z"
		/>
		<linearGradient
			id="ruby_svg__o"
			x1={80.214}
		...
		<path
			...
			d="m26.957 59.969-1.872 22.282c3.532 4.823 8.389 5.241 13.485 4.866-3.687-9.175-11.051-27.521-11.613-27.148"
		/>
		<linearGradient
			id="ruby_svg__p"
			x1={135.518}
		...
		<path
			...
			d="m79.919 10.02 26.237 3.683c-1.401-5.935-5.701-9.763-13.03-10.961z"
		/>
	</svg>
);
