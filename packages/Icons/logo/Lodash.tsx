...
const SvgLodash = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
	...
	>
		...
		<path fill="#3492ff" d="M0 107.863h127.816v13.539H0zm0 0" />
	</svg>
);
const ForwardRef = forwardRef(SvgLodash);
