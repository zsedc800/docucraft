...
const SvgDropwizard = (
	...
	>
		...
		<g
			clipPath="url(#dropwizard_svg__a)"
			transform="matrix(.03194 0 0 -.03194 26.222 125.997)"
		>
			<path
		...
		<g
			clipPath="url(#dropwizard_svg__c)"
			transform="matrix(.03194 0 0 -.03194 26.222 125.997)"
		>
			<path
		...
		<path
			fill="#f9a72b"
			d="m47.785 97.062 3.237-5.586 3.025 5.884-3.461 7.59zm26.436-21.14 3.238-5.586 3.025 5.885-3.463 7.589zm-18.1-22.307 3.238-5.585 3.024 5.885-3.462 7.587z"
		/>
		<path
			fill="#fff200"
			d="m47.785 97.062 3.242-6.541 3.02 6.84-3.456 5.595zm26.436-21.14 3.244-6.541 3.019 6.84-3.456 5.595-2.806-5.894m-18.1-22.307 3.242-6.54 3.019 6.84-3.457 5.594z"
		/>
		<path
			fill="#24265d"
			d="M51.012 112.36s23.19 3.868 38.455-5.904c-1.914 5.904-19.03 12.631-38.455 5.904"
		/>
	</svg>
);
