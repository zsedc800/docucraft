...
const SvgGithubcodespaces = (props: SVGProps<SVGSVGElement>) => (
	<svg
	...
	>
		...
		/>
		<path
			fill="url(#githubcodespaces_svg__a)"
			d="m124.97 63.867-14.719-7.087a4.45 4.45 0 0 0-5.077.863l-46.2 39.965a2.977 2.977 0 0 0 .003 4.402l7.904 7.547a2.98 2.98 0 0 0 3.801.169l40.941-31.744 9.647-10.638c.988-1.09 2.1-2.382 3.563-2.23 1.412.148 2.665 1.31 2.665 2.946v-.17a4.47 4.47 0 0 0-2.528-4.023"
		/>
		<path
			fill="url(#githubcodespaces_svg__b)"
			d="m124.97 119.88-14.719 7.087a4.45 4.45 0 0 1-5.077-.863l-46.2-43.933a2.977 2.977 0 0 1 .003-4.403l7.904-7.546a2.98 2.98 0 0 1 3.801-.17l40.941 35.713 9.647 10.639c.988 1.09 2.1 2.382 3.563 2.23 1.413-.149 2.665-1.311 2.665-2.947v.171a4.47 4.47 0 0 1-2.528 4.023z"
		/>
		<path
			fill="url(#githubcodespaces_svg__c)"
...
export default SvgGithubcodespaces;
