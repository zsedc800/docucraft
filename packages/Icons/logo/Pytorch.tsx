...
const SvgPytorch = (props: SVGProps<SVGSVGElement>) => (
	...
	>
		<path
			fill="#EE4C2C"
			d="m17.9 55.7-1.7 1.7c2.7 2.7 2.7 7.2 0 9.9S9 70 6.4 67.2c-2.7-2.7-2.7-7.2 0-9.9l4.4-4.4.6-.6V49l-6.6 6.6c-3.7 3.7-3.7 9.6 0 13.2s9.6 3.7 13.2 0c3.6-3.6 3.6-9.4-.1-13.1"
		/>
		<circle cx={14.6} cy={54.1} r={1.2} fill="#EE4C2C" />
		<path d="M34.9 64.1h-2.8v7.3H30V50.7h5.2c5.4 0 8 2.7 8 6.4 0 4.6-3.2 7-8.3 7m.2-11.3h-3v9.5l2.9-.1c3.9-.1 6-1.6 6-4.8.1-3-2.1-4.6-5.9-4.6m17.6 18.5-1.2 3.3c-1.4 3.7-2.8 4.7-4.9 4.7-1.1 0-2-.3-2.9-.7l.6-1.9c.7.4 1.5.7 2.3.7 1.1 0 2-.6 3.1-3.5l1-2.7-5.9-14.9H47l4.7 12.5 4.7-12.5h2.1z" />
