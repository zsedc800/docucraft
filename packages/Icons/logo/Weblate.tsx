	...
	>
		<g transform="translate(50 76)">
			...
			<linearGradient
				...
				y1={-0.952}
				y2={-6.318}
				gradientTransform="matrix(1.1631 0 0 .8598 116.308 0)"
				gradientUnits="userSpaceOnUse"
			>
			...
			<path
				fill="url(#weblate_svg__b)"
				fillRule="evenodd"
				d="M-20.8-3.7c-.7 0-1.3-.1-1.9-.4q-2.1-.9-3.6-3.3c.3-.5.5-1 .8-1.5.3-.7.6-1.4.8-2.1.5-1.7 6.8.5 5.9 3.2-.6 1.4-1.2 2.8-2 4.1m-7.7 7c-3.2 1.3-7 1.2-10.2-.2-3.7-1.7.1-7.5 2.2-6.3.8.4 1.6.7 2.4.8 1.6 2.4 3.5 4.3 5.6 5.7"
				clipRule="evenodd"
				opacity={0.3}
			/>
			<linearGradient
